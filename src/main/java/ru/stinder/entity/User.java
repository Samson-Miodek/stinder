...
public class User {
    ...
    public User(UserRegistrationDTO userAuthenticationDTO) {
        this.name = userAuthenticationDTO.getName();
        this.surname = userAuthenticationDTO.getSurname();
        this.email = userAuthenticationDTO.getEmail();
